...
{
    public class ProductManageRepository : IProductManageRepository
    {
        private readonly AppDBContext _context;
        public ProductManageRepository(AppDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> UpdateProductAsync(Guid Id, ProductViewModel productVm)
        {
        ...
        public async Task<IEnumerable<ProductViewModel>> GetAllProductsAsync()
        {
            ...
            {
                ProductViewModel productManageGetVM = new ProductViewModel()
                {
                    ProductId = product.ProductId,
                    BrandId = product.BrandId,
                    ProductName = product.ProductName,
